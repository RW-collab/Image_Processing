...
from PyQt5.QtCore import Qt #needs a Qt.KeepAspectRatio constant to resize while maintaining proportion
...
from PIL.imageFilter import(
    BLUR, CONTOUR, DETAIL, EDGE_ENHANCE, EDGE_ENCHANCE_MORE, 
...
col2 = QVBoxLayout()
col1.addWidget(btn_dir)     # in the first - directory selections button
...
class ImageProcessor():
    ...
    def loadImage(self, dir, filename):
        ...
        self.iamge.save(image_path)


    def do_bw(self):
        self.image = self.image.convert("L")
        self.saveImage()
        Image_path = os.path.join(self.dir, self.save_dir, save.filename)
    ...
    def saveImage(self):
        ...
        if not(os.path.exists(path) or os.path.isdir(path)):
            os.mkdir(path)
        Image_path = os.path.join(self.dir, self.save_dir)
    ...
    def showImage(self, path):
        ...
        pixmapimage = pixmmapimage.scaled(w, h, Qt.KeepAspectRatio)
